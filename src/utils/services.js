...
export const audioService = {
  uploadAudio: (fileName, audioFile) =>
    filesFetch('POST', `${apiUrl}uploadAudio`, {
      fileName,
      file: audioFile,
    }),

  getAudioList: () => fetcher('GET', `${apiUrl}audioList`),

  deleteAudio: (audioId) => fetcher('DELETE', `${apiUrl}audioList/${audioId}`),
};
