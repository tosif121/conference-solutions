...
export default function AssignDIDs() {
  ...
  const filteredAssignedDIDs = assignedDIDs.filter(did => 
    did.number.includes(searchQuery) || 
    did.admin.toLowerCase().includes(searchQuery.toLowerCase())
  )
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Assign and manage DID numbers for administrators</p>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select onValueChange={setDid} value={did} disabled={isLoading}>
                    <SelectTrigger className="h-10">
            ...
            <CardFooter className="border-t bg-slate-50 dark:bg-slate-900/50 px-6 py-4">
              <Button 
                ...
                disabled={!adminId || !did || isLoading} 
                className="ml-auto"
              >
                {isLoading ? (
                    ...
                    <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Are you sure you want to unassign {selectedDIDs.length} DID{selectedDIDs.length > 1 ? 's' : ''}? 
                      ...
                      filteredAssignedDIDs.map((did) => (
                        <TableRow key={did.id}>
                          ...
                          <TableCell className="text-right">
                            <Button variant="ghost" size="sm" className="h-8 w-8 p-0" onClick={() => handleSelectDID(did.id)}>
